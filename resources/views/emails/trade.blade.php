											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													...
													<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="color:#282828;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:19px;line-height:120%;text-align:center;mso-line-height-alt:22.8px;">
													...
													<table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="color:#111;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;line-height:150%;text-align:center;mso-line-height-alt:22.5px;">
																	<p style="margin: 0; word-break: break-word;">Un nouveau trade a été ajouté avec succès.</p>
																	<p style="margin: 0; word-break: break-word;">&nbsp;</p>
																	<p style="margin: 0;">Voici les détails :</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;"><strong>Titre :</strong> &nbsp;{{ $trade->titre }}</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;"><strong>Description :</strong></p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">{{ $trade->description }}</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;"><strong>Email :&nbsp;</strong>{{ $trade->email }}</p>
																	<p style="margin: 0;">&nbsp;</p>
																</div>
															</td>
														</tr>
